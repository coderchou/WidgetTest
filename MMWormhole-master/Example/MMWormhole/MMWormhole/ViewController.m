...
- (void)viewDidLoad {
    ...
    self.traditionalWormhole = [[MMWormhole alloc] initWithApplicationGroupIdentifier:@"group.com.coderchou.wormhole"
    ...
    self.watchConnectivityWormhole = [[MMWormhole alloc] initWithApplicationGroupIdentifier:@"group.com.coderchou.wormhole"
                                                                          optionalDirectory:@"wormhole"
    ...
    [self.traditionalWormhole listenForMessageWithIdentifier:@"button" listener:^(id messageObject) {
        ...
        NSLog(@"接收到widget消息 : %@",self.numberLabel.text);
    }];
